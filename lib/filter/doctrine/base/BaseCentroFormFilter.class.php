...
abstract class BaseCentroFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'adultos_meconomico'  => new sfWidgetFormFilterInput(),
      'adultos_feconomico'  => new sfWidgetFormFilterInput(),
      'adultos_mtecnica'    => new sfWidgetFormFilterInput(),
      'adultos_ftecnica'    => new sfWidgetFormFilterInput(),
      'adultos_mproductiva' => new sfWidgetFormFilterInput(),
      'adultos_fproductiva' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'adultos_meconomico'  => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'adultos_feconomico'  => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'adultos_mtecnica'    => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'adultos_ftecnica'    => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'adultos_mproductiva' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'adultos_fproductiva' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      ...
      'adultos_meconomico'  => 'Number',
      'adultos_feconomico'  => 'Number',
      'adultos_mtecnica'    => 'Number',
      'adultos_ftecnica'    => 'Number',
      'adultos_mproductiva' => 'Number',
      'adultos_fproductiva' => 'Number',
      'adultos_f'           => 'Number',
      'adultos_m'           => 'Number',
      'adultos_t'           => 'Number',
      'latitud'             => 'Text',
