...
abstract class BaseCentroForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'adultos_meconomico'  => new sfWidgetFormInputText(),
      'adultos_feconomico'  => new sfWidgetFormInputText(),
      'adultos_mtecnica'    => new sfWidgetFormInputText(),
      'adultos_ftecnica'    => new sfWidgetFormInputText(),
      'adultos_mproductiva' => new sfWidgetFormInputText(),
      'adultos_fproductiva' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'adultos_meconomico'  => new sfValidatorInteger(array('required' => false)),
      'adultos_feconomico'  => new sfValidatorInteger(array('required' => false)),
      'adultos_mtecnica'    => new sfValidatorInteger(array('required' => false)),
      'adultos_ftecnica'    => new sfValidatorInteger(array('required' => false)),
      'adultos_mproductiva' => new sfValidatorInteger(array('required' => false)),
      'adultos_fproductiva' => new sfValidatorInteger(array('required' => false)),
